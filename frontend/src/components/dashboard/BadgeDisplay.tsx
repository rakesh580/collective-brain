...
export default function BadgeDisplay(props: Props) {
 ...
 <h3 className="text-sm font-semibold text-slate-700">Achievements</h3>
 </div>
 ...
 badge.earned
 ? "bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200" : "bg-base/30 border-default opacity-40" }`}
